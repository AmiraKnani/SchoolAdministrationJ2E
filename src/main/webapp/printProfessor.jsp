...
<br/>
	...
	<div class="page-content">
		<div class="form-v10-content">
			<form class="form-detail" action="print" method="post" id="myform">
				<div class="form-left">
		 ...
		 <!-- Copyright Section-->
				...
				<a href="printProfessor" class="btn btn-outline-secondary  btn-lg active" role="button" aria-pressed="true" ><div class="fas fa-redo-alt"></div></a>
