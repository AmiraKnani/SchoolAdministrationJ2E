...
<!-- Navigation-->
	...
	<!-- Content --><br/><br/><br/><br/>
		...
		<div class="form-v10-content">
			<form class="form-detail" action="editProfessor" method="post" id="myform">
				<div class="form-left">
					...
					<div class="form-row">
						<input type="text" name="subject" class="company" id="company" placeholder="Subject" >
					</div>
					<div class="form-group">
	 ...
	 <!-- Copyright Section-->
				...
				<a href="editProfessor" class="btn btn-outline-secondary  btn-lg active" role="button" aria-pressed="true" ><div class="fas fa-redo-alt"></div></a>
