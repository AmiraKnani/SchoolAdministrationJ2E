...
<!-- Navigation-->
	...
	<!-- Content --><br/><br/><br/><br/>
		...
		<div class="form-v10-content">
			<form class="form-detail" action="editGrades" method="post" id="myform">
				<div class="form-left">
					<h2>General Infomation</h2>
					<div class="form-row">
					
					<input type="text" name="idS" class="idS" id="idS" placeholder="Id Student" >
					</DIV>
					<div class="form-row">
					
					<input type="text" name="idM" class="idM" id="idM" placeholder="Id Subject" >
					</DIV>
					<div class="form-row">
						<select name="title">
						    ...
						    <option class="option" value="Languages">Languages</option>
					...
					<div class="form-row">
						<input type="number" name="grade" class="grade" id="grade" placeholder="Grade" >
					</div>
				...
				<div class="form-right">
					...
					<figure>
							<img src="images/grade.png" alt="editStudent image"  height="250" width="400" style = "position:relative; left:70px; " 
     height="200">
						</figure>
				</div>
			</form>
	 ...
	 <!-- Copyright Section-->
				...
				<a href="editGrades" class="btn btn-outline-secondary  btn-lg active" role="button" aria-pressed="true" ><div class="fas fa-redo-alt"></div></a>
