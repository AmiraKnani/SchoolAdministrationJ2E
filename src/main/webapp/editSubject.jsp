...
<!-- Navigation-->
	...
	<!-- Content --><br/><br/><br/><br/>
		...
		<div class="form-v10-content">
			<form class="form-detail" action="editSubject" method="post" id="myform">
				<div class="form-left">
					<h2>General Infomation</h2>
					<div class="form-row">
					
					<input type="text" name="idS" class="idS" id="idS" placeholder="Id Subject" >
					</DIV><div class="form-row">
						<select name="title">
							<option class="option" value="subject">Select subject</option>
						    <option class="option" value="Maths">Maths</option>
						    <option class="option" value="Physics">Physics</option>
						    <option class="option" value="Information Technology">Information Technology</option>
						    <option class="option" value="anguages">Languages</option>
						    <option class="option" value="Soft Skills">Soft Skills</option>
						</select>
					...
					<div class="form-row form-row-1">
							<input type="number" name="coefficient" class="coefficient" id="coefficient" placeholder="Coefficient" >
						</div>
					<div class="form-row">
					...
					<div class="form-row">
						<input type="number" name="idP" class="idP" id="idP" placeholder="Id Professor" >
					</div>
				...
				<div class="form-right">
					...
					<figure>
							<img src="images/Subject.png" alt="editStudent image"  height="250" width="400" style = "position:relative; left:70px; " 
     height="200">
						</figure>
				</div>
			</form>
	 ...
	 <!-- Copyright Section-->
				...
				<a href="editSubject" class="btn btn-outline-secondary  btn-lg active" role="button" aria-pressed="true" ><div class="fas fa-redo-alt"></div></a>
